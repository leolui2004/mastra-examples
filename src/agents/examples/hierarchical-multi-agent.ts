...
export const hierarchicalMultiAgentExample: ExampleConfig = {
  id: 'hierarchical-multi-agent',
  title: 'Hierarchical Multi-Agent System',
  description: 'A complex system with publisher, copywriter, and editor agents working together to create blog posts',
  type: 'chat',
